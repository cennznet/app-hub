...
import { Balance, extractNominators, getTokenLogo } from "@/libs/utils";
import {
	DeriveHeartbeats,
	ElectedCandidate,
	Result,
...
import { poolRegistry } from "@/libs/utils/poolRegistry";
import { useCENNZApi } from "@/libs/providers/CENNZApiProvider";
import StakeValidatorStatus from "@/libs/components/StakeValidatorStatus";
...
const StakeValidatorTable: VFC = () => {
	...
	const chain = CENNZ_NETWORK.ChainName;
